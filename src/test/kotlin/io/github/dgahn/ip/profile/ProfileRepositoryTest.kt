...
import io.github.dgahn.ip.fixture.ObjectFixture.Companion.nullIdProfiles
...
object ProfileRepositoryTest {
    ...
    @Test
    fun `findProfileSummaryList()을 호출하면 3개의 Profile 요약 정보를 반환합니다`() {
        // given
    ...
    @Test
    fun `save()을 호출하면 Profile에 Id가 부여됩니다`() {
        // given
    ...
    @Test
    fun `findById(1)을 호출하면 Id가 1이고 프로퍼티가 NotNull Profile의 정보를이 반환합니다`() {
        // given
        val profile = nullIdProfiles[0]
        profileRepository.save(profile)
        val id = 1L
        ...
        assertThat(findProfile.metadata).isNotNull
    }
